...
//
  ...
  // Match the web themes: tight code line-spacing, and a zero-width break after each comma so long space-less numeric lists (e.g. SQL IN-lists) wrap instead of overflowing and opening a gap.
...
//
  ...
  show heading.where(level: 1): it => align(left, block(above: 1.5em, below: 1.2em, width: 100%, text(font: font, weight: "semibold", size: 22pt, { set par(leading: 0.4em); show raw: set text(size: 1em); it.body })))

  show heading.where(level: 2): it => align(left, block(above: 1.3em, below: 1.1em, width: 100%, text(font: font, weight: "semibold", size: 17pt, { set par(leading: 0.4em); show raw: set text(size: 1em); it.body })))

  show heading.where(level: 3): it => align(left, block(above: 1.2em, below: 1em, text(font: font, weight: "semibold", size: 15pt, { set par(leading: 0.4em); show raw: set text(size: 1em); it.body })))

  show heading.where(level: 4): it => align(left, block(above: 1em, below: 0.9em, text(font: font, weight: "bold", size: 13pt, { set par(leading: 0.4em); show raw: set text(size: 1em); it.body })))

  show heading.where(level: 5): it => align(left, block(above: 1em, below: 0.85em, text(font: font, weight: "bold", size: 12pt, { set par(leading: 0.4em); show raw: set text(size: 1em); it.body })))

  show heading.where(level: 6): it => align(left, block(above: 1em, below: 0.85em, text(font: font, weight: "regular", style: "italic", size: 12pt, { set par(leading: 0.4em); show raw: set text(size: 1em); it.body })))
